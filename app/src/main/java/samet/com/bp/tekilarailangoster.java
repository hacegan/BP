        ...
        protected Object doInBackground(Object[] params) {
            ...
            try{
                ...
                while (token.hasMoreTokens()) {
                    ...
                    String odaara1bay=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    ...
                    String odaara3yas=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara3yas = "+odaara3yas);

                    String odaara4meslek=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara4meslek = "+odaara4meslek);

                    String odaara5evet=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara5evet = "+odaara5evet);

                    String odaara6evet=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    ...
                    String odaara10butce=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara10butce = "+odaara10butce);

                    String odaara11tarih=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara11tarih = "+odaara11tarih);

                    String odaara12sure=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    System.out.println("odaara12sure = "+odaara12sure);

                    String odaara13numara=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
                    ...
                    String odaara14aciklama=temp.substring(temp.indexOf("ilanbaslik:"),temp.indexOf("-",temp.indexOf("ilanbaslik:")) );
